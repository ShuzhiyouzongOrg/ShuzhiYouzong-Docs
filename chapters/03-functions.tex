...
游客进入页面后由数字人播报欢迎语；可直接文字提问，也可启动\textbf{浏览器语音识别}。问答结果同时呈现\textbf{答案、质量标签、来源和时延}，数字人按情绪标签播报。景点卡片触发约一分钟讲解，路线偏好面板采集时长、兴趣、亲子和拍照需求，结果节点可继续点击讲解。会话末尾支持\textbf{赞踩、1--5分和文字反馈}。
