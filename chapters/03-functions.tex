...
图\ref{fig:web-real-screens}和图\ref{fig:harmony-real-screens}均来自当前可运行系统，而非概念效果图。Web端展示数字人问答与景区手绘地图上的真实点位；HarmonyOS截图来自HAP在Pura 90模拟器的安装运行结果，覆盖首页、个人服务与AI导游主链路。Android APK与微信小程序的真实运行截图统一放在第\ref{sec:multiplatform-delivery}节，便于评审连续核对多端交付证据。
