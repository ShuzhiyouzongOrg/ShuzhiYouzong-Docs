...
系统不是单一聊天机器人，而是由本地景区知识库、可调用大模型、语音识别与合成、交互式数字人、路线推荐和运营分析共同组成的\textbf{服务闭环}。当前工程已形成Vue 3游客端与管理端、Node.js API、SQLite持久化、\textbf{44个知识分块和22个景点实体}，并以\textbf{全局国际化层与可替换数字人引擎}支撑跨语言、可持续的导览服务。
...
产品边界聚焦\textbf{灵山胜境与拈花湾资料包}；不替代票务交易、导航地图和景区应急指挥系统，但预留\textbf{GPS伴随讲解、向量检索和更多终端形态}的扩展接口。
